...
#Defaults
EXP_NAME = 'CIFAR10_ResNet18_NuAT-WA'
l_ce = 1.0
Nuc_reg = Nuc_max = 4
TRAIN_BATCH_SIZE = 64
Feps = 8.0
...
tau = 0.9998
exp_avg = []
exp_avg.append(model.state_dict())
...
for epoch in range(epochs):
    ...
    for data, target in train_loader:
        ...
        for key,value in model.state_dict().items():
            exp_avg[0][key] = (1-tau)*value + tau*exp_avg[0][key]
    ...
    torch.save(exp_avg[0],"models/"+EXP_NAME+"_SWA_"+str(tau)+"_"+str(epoch)+'.pkl')
